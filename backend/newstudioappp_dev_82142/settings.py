"""
Django settings for newstudioappp_dev_82142 project.
...
ROOT_URLCONF = 'newstudioappp_dev_82142.urls'
...
WSGI_APPLICATION = 'newstudioappp_dev_82142.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newstudioappp_dev_82142 API",
    "DESCRIPTION": "API documentation for newstudioappp_dev_82142 App",
    "VERSION": "v1",
}
